...
\begin{figure}[h!]
\begin{center}
\includegraphics[scale=0.3]{distrLeft.jpg}
...
\node at (0,-8.2) [text width=\descrTextWidth, align=center] {t depends on RT};
...
\draw[->,thick] (earned.east) to [out=0, in=0] node [text width=0.2\textwidth, midway,fill=white] {After a choice, a new game is started.} (shuffled.east);
...
\begin{figure}[h!]
\begin{center}
\includegraphics[scale=0.3]{distrRight.jpg}
\caption{An outcome during a distractor trial.}
\label{distrRight}
\end{center}
\end{figure}
