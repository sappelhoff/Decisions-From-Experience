...
\node[inner sep=0pt] (trialCount) at (0,-4)
    {\fcolorbox{red}{red}{\includegraphics[width=\imgSize]{b_counter.jpg}}};    

\node[inner sep=0pt] (outcome) at (0,-8)
    {\fcolorbox{red}{red}{\includegraphics[width=\imgSize]{red_right.jpg}}};
...
\draw[->,thick] (outcome.west) to [out=180,in=180] node[text width=0.2\textwidth, left, fill=white, align=center]{$1250\pm250$ ms \\ Increment trial counter and repeat until max trial is reached} (trialCount.west) ;


\draw[->,thick] (prefLot.west) to [out=180,in=180] node[text width=0.2\textwidth, near start, fill=white, align=center] {t depends on RT \\ Increment game counter and repeat until max game is reached} (shuffled.west);
...
\node[inner sep=0pt] (trialCount) at (0,-3)
    {\fcolorbox{red}{red}{\includegraphics[width=\imgSize]{sp_counter.jpg}}};    

\node[inner sep=0pt] (outcome) at (-3,-6)
    {\fcolorbox{red}{red}{\includegraphics[width=\imgSize]{red_left.jpg}}};
    
\node[inner sep=0pt] (spChoice) at (3,-6)
    {\fcolorbox{red}{red}{\includegraphics[width=\imgSize]{outRedLeft.jpg}}};
 
\node[inner sep=0pt] (question) at (0,-12)
    {\fcolorbox{red}{red}{\includegraphics[width=\imgSize]{spQuestion.jpg}}}; 
   
\node[inner sep=0pt] (spQuestionSample) at (-4,-15)
    {\fcolorbox{red}{red}{\includegraphics[width=\imgSize]{spQuestionSample.jpg}}};

\node[inner sep=0pt] (spQuestionChoice) at (4,-15)
    {\fcolorbox{blue}{blue}{\includegraphics[width=\imgSize]{spQuestionChoice.jpg}}};

\node[inner sep=0pt] (noTrials) at (8,-15)
    {\fcolorbox{green}{green}{\includegraphics[width=\imgSize]{spNoTrials.jpg}}}; 
...
\node[inner sep=0pt] (outcomeChoice) at (4,-21)
    {\fcolorbox{blue}{green}{\includegraphics[width=\imgSize]{outBlueRight.jpg}}};
    
\node[inner sep=0pt] (earn) at (4,-24)
    {\fcolorbox{blue}{green}{\includegraphics[width=\imgSize]{earnZero.jpg}}};
...
\draw[->,thick] (earn.east) to [out=0,in=0] node[text width=0.2\textwidth, near end, fill=white, align=center] {t depends on RT \\ Trial counter is not incremented. If trial counter at max, paradigm is stopped.} (shuffled.east);
