...
\node[inner sep=0pt] (lotShuffle) at (0,0)
    {\fcolorbox{blue}{blue}{\includegraphics[width=\imgSize]{lotShuffle.jpg}}};

\node[inner sep=0pt] (trialCount) at (0,-4)
    {\fcolorbox{red}{red}{\includegraphics[width=\imgSize]{pfpCounter.jpg}}};    

\node[inner sep=0pt] (fixcross) at (0,-8)
    {\fcolorbox{red}{red}{\includegraphics[width=\imgSize]{fixcross.jpg}}};
    
\node[inner sep=0pt] (outcome) at (0,-12)
    {\fcolorbox{red}{red}{\includegraphics[width=\imgSize]{outBlueRight.jpg}}};
 
\node[inner sep=0pt] (earn) at (0,-16)
    {\fcolorbox{blue}{blue}{\includegraphics[width=\imgSize]{earnZero.jpg}}}; 
