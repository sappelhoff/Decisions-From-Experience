...
%
% [fixWidth, fixCoords, colors1, colors2, colors3, rectLocs, maskLocs, maskTexture] = produce_stims(window, windowRect, screenNumber)
%
% IN:
...
rectLocs = cat(3, allRectsLeft, allRectsRight, allRectsCenter)              ; %  (:,:,1) will be left, (:,:,2) will be right, (:,:,3) for center
...
maskLocs = cat(3, leftMask, rightMask, centerMask)                          ; % (:,:,1) will be left, (:,:,2) will be right, (:,:,3) will be center
